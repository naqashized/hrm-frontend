...
export class TableFilterComponent {
  ...
  constructor(private service: DesignationService, private router: Router,@Inject(LOCAL_STORAGE) public local: WebStorageService) {
  ...
  edit(event){
    ...
    this.router.navigate ( [ '/designation/edit/'+event ] );
  }
